...
os.system("clear")
os.system("figlet omnikit Tools v3")
...
17-) Açıklama ve Nasıl Kullanılır? 
...
6-) P3bg u¢ generatorv3 

7-) Kullanıcı Adı ile Hesap Bulma

8-) T¢ Son 2 Hane Bulma
...
9-) An0nimSMS (demo)
	...
	if(yeraltisecim=="1"):
		...
		print("")
		print("WATTPAD >  ","hhttps://www.wattpad.com/user/"+hesapbul)
		print("")
		...
		import requests
		print("günlük 1 mesaj hakkınız vardır")
