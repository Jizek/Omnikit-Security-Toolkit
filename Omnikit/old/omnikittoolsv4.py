...
os.system("clear")
os.system("figlet omnikit Tools v4")
...
20-) Açıklama ve Nasıl Kullanılır? 
...
örnek link: http://www.suesupriano/article.php?id=25
	...
	os.system("apt-get install figlet")
	os.system("clear")
	os.system("figlet omnikitin yeraltIsI")
	print('''
...
8-) P3bg u¢ generatorv3 

9-) Kullanıcı Adı ile Hesap Bulma

10-) T¢ Son 2 Hane Bulma

11-) An0nimSMS (demo)

12-) Telefon Numarasından Şehir Bulma (TRde demo)
...
çalışmayan toollar vb için iletişim: 
twitter: omnikit
instagram: omnikit
...
##############################
2.Tool ise Güvenlik duvarı tespit etmeye yarar.Örneğin omnikit.weebly.com yazarak test edebilirsiniz wafw00f kullanarak tespit eder
##############################
