...
print('''Yaptığınız ve yapacağınız her şeyden siz sorumlusunuz.
		         omnikit asla sorumluluk kabul etmez. 
...
if(oltalama=="1"):
	...
	print("omnikittool, verileri daha kolay depolayabilmeniz için resimleri txt formatında tutar. İstediğiniz zaman bu txt dosyasını (oltalama/base64_images.txt) resimlere çevirebilirsiniz.")
