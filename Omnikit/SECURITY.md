...
TR:
Eğer sürümün yanında desteklenmediğine dair işaret varsa (x) omnikittool siber güvenlik aracını güncelleyiniz. Yalnızca güncel sürümleri kullanmanız önerilir.
...
EN:
If you encounter any bugs or security vulnerabilities, you can contact me from the contact section in metfora or the README.md file in the main directory. Update the omnikittool cybersecurity tool if there is a sign next to the version that it is not supported (x). It is recommended to use only current versions.
